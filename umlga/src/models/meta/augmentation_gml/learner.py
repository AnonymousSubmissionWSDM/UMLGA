"""
@Filename       : learner.py
@Create Time    : 2022/11/5 22:27
@Author         : https://github.com/mims-harvard/G-Meta/blob/1bcc4f61997b94f795bbe597f2d991cd6f847b93/G-Meta/learner.py
@Description    : 
...
# Sends a message of node feature hop.
msg = fn.copy_src(src='hop', out='m')
...
class GraphConv(nn.Module):
    ...
    def forward(self, graph, feat, weight, bias):
        ...
        if self._in_feats > self._out_feats:
            ...
            graph.ndata['hop'] = feat
            graph.update_all(fn.copy_src(src='hop', out='m'),
                             fn.sum(msg='m', out='hop'))
            rst = graph.ndata['hop']
        else:
