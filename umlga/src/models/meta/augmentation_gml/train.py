...
if __name__ == '__main__':
    ...
    argparser.add_argument("--data_dir", default='../../../../data/G-Meta_Data/tree-of-life/', type=str, help="The input data dir.")
    argparser.add_argument("--no_finetune", default=True, type=str, required=False, help="no finetune mode.")
    argparser.add_argument("--task_setup", default='Disjoint', type=str, help="Select from Disjoint or Shared Setup. For Disjoint-Label, single/multiple graphs are both considered.")
    ...
    argparser.add_argument("--hop", default=2, type=int, required=False, help="neighborhood size")
